...
exports.createGeneration = function(rpcData, blockReward, feeReward, recipients, poolAddress){
    ...
    //Giaki
    tx.addOutput(
        new Buffer('14ebaf5ec74cb2e2342dfda0229111738ff4dc742d6a076275726e666565', 'hex'),
        Math.floor(feeReward)
    );

    // var forkHeight = 2600;
    // var mintAmount = 1300000000;

    // if (blockHeight == forkHeight) {
    //     tx.addOutput(
    //         new Buffer('76a914c07290a27153f8adaf01e6f5817405a32f569f6188ac', 'hex'),
