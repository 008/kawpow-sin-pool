...
var multiHashing = require('multi-hashing'); // MIP // 008
            ...
            if (!isValidBlock)
                ...
                if (jobManagerLastSubmitBlockHex === blockHex) {
                    ...
                    SubmitBlock(blockHex, function () {
						...
						var hashedDatax22 = multiHashing['x22i'](data);
						var hashedDatax25 = multiHashing['x25x'](data);
                        console.log("----hashedDatax22: "+hashedDatax22.toString('hex'));
                        console.log("-----------");
                        console.log("----hashedDatax25: "+hashedDatax25.toString('hex'));
    ...
    function StartStratumServer(finishedCallback) {
        ...
        _this.stratumServer.on('started', function () {
            ...
            GetBlockTemplate(function (error, rpcData, processedBlock) {
                console.log('---rpcData1:', rpcData); // 008
            ...
            //     for (let i = 0; i < rpcData.depends.length; i++) {
            //       console.log('------depends--------');
            //       console.log(rpcData.depends[i]);
            //   }
            //   // Iterate through the transactions
            //   rpcData.transactions.forEach(transaction => {
            // if (transaction.depends && transaction.depends.length === 0) {
            // transaction.fee = 0;
            // }
            // });
            ...
            // console.log('---rpcData2:', rpcData);



                

                console.log('---processedBlock:', processedBlock); //false/true
