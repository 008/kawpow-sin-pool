...
console.log('-----------');
        ...
        _this.daemon.batchCmd(batchRpcCalls, function (error, results) {
            ...
            options.testnet = rpcResults.getmininginfo.testnet;
            options.protocolVersion = (rpcResults.getmininginfo.chain == 'test' ? true : false);

            options.initStats = {
                connections: rpcResults.getmininginfo.connections,
    ...
    function CheckBlockAccepted(blockHash, callback) {
        console.log('---CheckBlockAccepted-----');
