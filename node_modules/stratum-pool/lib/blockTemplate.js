...
var BlockTemplate = module.exports = function BlockTemplate(jobId, rpcData, reward, recipients, poolAddress){
    ...
    var blockReward = this.rpcData.coinbasevalue;
    console.log('---coinbasevalue---'+blockReward);
    // console.log(blockReward);
    // if (blockReward > 1182000000) {
    //     blockReward = 1173000000;
    // }
    ...
    console.log('-- fee  debug start --');
    console.log("---rpcData333---:"+JSON.stringify(rpcData));
    console.log('-------');
    console.log("---fees---:"+JSON.stringify(fees));
    console.log('-------');
    console.log("---rpcData.rewardFees---:"+rpcData.rewardFees);
    console.log('-- fee  debug end --');
    ...
    //     console.log('-- fee undefined debug start --');
    //     console.log('this.genTxHash: ' + transactions.txHash()); // 008
    //     console.log('this.merkleRoot: ' + merkle.getRoot(rpcData, this.genTxHash));
    //     console.log('-- fee undefined debug end --');
    }
