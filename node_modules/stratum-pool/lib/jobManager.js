  ...
  this.processShare = function (miner_given_jobId, previousDifficulty, difficulty, miner_given_nonce, ipAddress, port, workerName, miner_given_header, miner_given_mixhash, extraNonce1, callback_parent) {
    ...
    if (options.kawpow_validator == "kawpowd") {
      ...
      _this.daemon.cmd('getkawpowhash', [ header_hash, miner_given_mixhash, miner_given_nonce, job.rpcData.height, job.target_hex ], function (results) {
        ...
        // console.log('-------nonce--------');
        // console.log('header_hash: ' +header_hash);
        // console.log('miner_given_mixhash '+miner_given_mixhash);
        // console.log('miner_given_nonce: ' +miner_given_nonce);
        // console.log('job.rpcData.height: '+job.rpcData.height);
        // console.log('job.target_hex: '+job.target_hex);
        // console.log('-------nonce--------');
        // console.log('response digest: '+ JSON.stringify( results[0].response.digest));

        // console.log(JSON.stringify(results[0].response, (key, value) => {
        //   if (value !== null) return value
        // }))

        // console.log(JSON.stringify(results[0], (key, value) => {
        //   if (value !== null) return value
        // }))


        // console.log('response result: '+ JSON.stringify( results[0].response.result));
