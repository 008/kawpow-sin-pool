...
var JobManager = module.exports = function JobManager(options) {
  ...
  this.processShare = function (miner_given_jobId, previousDifficulty, difficulty, miner_given_nonce, ipAddress, port, workerName, miner_given_header, miner_given_mixhash, extraNonce1, callback_parent) {
    ...
    console.log("--here3--");
    // console.log("JOB2: "+job); // [object Object]
    ...
    // data.rpcData.transactions.forEach(transaction => {
    //     if (transaction.depends && Array.isArray(transaction.depends) && !transaction.depends[0]) {
    //         transaction.fee = 0;
    //     }
    // });
    ...
    var blockHash;
    var blockHex;
    options.kawpow_validator = "(web link not set)"; //008 (node:29480) [DEP0109] DeprecationWarning: The provided URL http://undefined:undefined/?header_hash=3118e7811e1349cc70ad4a5c6cc17868e8cf84ed12ad015e8588527773e66395&mix_hash=5e7224cdea0ee9c6234f3f907d8cb94e834c2a8af007113b12a30c0de84fdd94&nonce=87c100000a609093&height=1686636&share_boundary=00000002d8924924924940000000000000000000000000000000000000000000&block_boundary=00000002ff180000000000000000000000000000000000000000000000000000 is not a valid URL, and is supported in the http module solely for compatibility.
    ...
    if (options.kawpow_validator == "kawpowd") {
      ...
      _this.daemon.cmd('getkawpowhash', [ header_hash, miner_given_mixhash, miner_given_nonce, job.rpcData.height, job.target_hex ], function (results) {
        ...
        console.log('--getkawpowhash-----');
        console.log(digest);
        console.log(result);
        console.log(mix_hash);
        console.log(meets_target);
        console.log('--getkawpowhash-----');
